...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-willpfigueiredo;protocol=ssh;branch=master"

PV = "1.0+git${SRCPV}"
# DONE: set to reference a specific commit hash in your assignment repo
SRCREV = "f19576f9a648efb2bfb5037f859a6a03d007513d"
